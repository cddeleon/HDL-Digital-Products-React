        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text17">#</span>
                </Fragment>
              )}
            </a>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text25">Search</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text18">Cart</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text15">About Us</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text27">Contact</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page3: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1619646081160-033d1d793388?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1ODcyNzQ1NHw&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage4: 'https://www.teleporthq.io',
  page2ImageAlt: 'Products Image',
  page3ImageAlt: 'About Us Image',
  page2Description: undefined,
  link1: undefined,
  action2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1722239650422-2b9ecda8765b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1ODcyNzQ1M3w&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1748231344987-6f5038d76817?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1ODcyNzQ1NHw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  link4: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1695634365294-7e50d731722b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1ODcyNzQ1NHw&ixlib=rb-4.1.0&q=80&w=1080',
  action1: undefined,
