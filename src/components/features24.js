          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text5">Digital Product 1</span>
                  </Fragment>
                )}
              </h2>
          ...
          >
            ...
            <div className="features24-content2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features24-text3">Digital Product 2</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text2">Digital Product 3</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
...
Features24.defaultProps = {
  ...
  feature1ImgAlt: 'Digital product image 1',
  feature2Title: undefined,
  feature3ImgAlt: 'Digital product image 3',
  feature2ImgSrc:
  ...
  feature2ImgAlt: 'Digital product image 2',
  feature1ImgSrc:
